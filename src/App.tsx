...
export default function App() {
  const steps = [
    ...
    { id: 4, text: "Claim your Sam's Club gift card" },
  ];
    ...
    <>
      <div className="hidden md:flex min-h-screen bg-[#f8f9fa] flex-col items-center justify-center p-6 font-sans">
        ...
        <p className="text-[#64748b] max-w-[480px] text-[16px] leading-[1.6] text-center font-medium">
          This exclusive <strong className="text-[#334155] font-bold">Sam's Club</strong> member reward is only accessible on mobile devices. Please open this site on your smartphone to continue.
        </p>
      </div>

      <div className="md:hidden min-h-screen bg-[#f4f6f8] flex flex-col font-sans">
        {/* Top Banner */}
        <div className="w-full bg-[#0067a0] text-white py-[6px] px-4 flex justify-center items-center shadow-sm flex-none">
        ...
        <div className="w-full max-w-[400px] mx-auto flex flex-col py-6 px-5">
          ...
          <div className="mb-8 w-full text-center">
            <div className="flex justify-center items-center mb-4 mt-2">
              <div className="flex flex-col items-center justify-center">
                <div className="w-[106px] h-[106px] bg-[#0b509d] rounded-[24px] flex flex-col items-center justify-center shadow-md pb-1 relative">
                  <svg width="46" height="28" viewBox="0 0 50 28" xmlns="http://www.w3.org/2000/svg" className="mb-[2px]">
                    <path d="M 20 2 L 32 14 L 20 26 L 8 14 Z" fill="#2eb0e5" />
                    <path d="M 30 2 L 42 14 L 30 26 L 18 14 Z" fill="#3bb520" />
                    <path d="M 25 7 L 32 14 L 25 21 L 18 14 Z" fill="#06488d" />
                  </svg>
                  <span className="text-white text-[34px] leading-[1] tracking-[0px]" style={{ fontFamily: 'Georgia, "Times New Roman", serif', letterSpacing: '-0.5px' }}>
                    Sam's
                  </span>
                  <span className="text-white text-[11px] font-bold tracking-[0.25em] font-sans mt-[2px] ml-[3px]">
                    CLUB
                  </span>
                </div>
              </div>
          ...
          <div className="w-full bg-white rounded-[20px] border border-slate-200 shadow-sm overflow-hidden mb-8">
            <ul className="flex flex-col">
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-[28px] h-[28px] rounded-full bg-[#0067a0] text-white flex items-center justify-center font-bold text-[13px] select-none">
                    {step.id}
                  </div>
          ...
          <div className="w-full flex flex-col items-center mb-8">
            <button 
              onClick={() => {
                const url = 'https://giftclick.org/aff_c?offer_id=2965&aff_id=144760';
                window.location.href = url;
              }}
              className="block w-full text-center bg-[#0067a0] hover:bg-[#004f7c] text-white font-bold text-[22px] py-[16px] rounded-[10px] transition-all duration-200 shadow-[0_15px_30px_-5px_rgba(0,103,160,0.5)] cursor-pointer select-none"
            >
              Claim Your Reward
            </button>
            ...
            <p className="mt-3 text-[13px] text-[#78828e] text-center leading-[1.6]">
              To qualify for your Sam's Club gift card, you'll need to complete 3-5 required deals to unlock the full $750 reward. Be sure to finish each deal from start to completion. Once all required deals are successfully completed, you'll be eligible to claim your reward.
            </p>
